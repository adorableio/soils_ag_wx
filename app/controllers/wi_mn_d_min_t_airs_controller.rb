class WiMnDMinTAirsController < ApplicationController
  ...
  # GET /wi_mn_d_min_t_airs.json
  def index
    @wi_mn_d_min_t_airs = WiMnDMinTAir.all
  end

  # GET /wi_mn_d_min_t_airs/1
  # GET /wi_mn_d_min_t_airs/1.json
  def show
  end

  # GET /wi_mn_d_min_t_airs/new
  def new
    @wi_mn_d_min_t_air = WiMnDMinTAir.new
  end

  # GET /wi_mn_d_min_t_airs/1/edit
  def edit
  end

  # POST /wi_mn_d_min_t_airs
  # POST /wi_mn_d_min_t_airs.json
  def create
  ...
  # PATCH/PUT /wi_mn_d_min_t_airs/1
  # PATCH/PUT /wi_mn_d_min_t_airs/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /wi_mn_d_min_t_airs/1
  # DELETE /wi_mn_d_min_t_airs/1.json
  def destroy
