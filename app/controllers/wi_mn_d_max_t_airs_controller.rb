class WiMnDMaxTAirsController < ApplicationController
  ...
  # GET /wi_mn_d_max_t_airs.json
  def index
    @wi_mn_d_max_t_airs = WiMnDMaxTAir.all
  end

  # GET /wi_mn_d_max_t_airs/1
  # GET /wi_mn_d_max_t_airs/1.json
  def show
  end

  # GET /wi_mn_d_max_t_airs/new
  def new
    @wi_mn_d_max_t_air = WiMnDMaxTAir.new
  end

  # GET /wi_mn_d_max_t_airs/1/edit
  def edit
  end

  # POST /wi_mn_d_max_t_airs
  # POST /wi_mn_d_max_t_airs.json
  def create
  ...
  # PATCH/PUT /wi_mn_d_max_t_airs/1
  # PATCH/PUT /wi_mn_d_max_t_airs/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /wi_mn_d_max_t_airs/1
  # DELETE /wi_mn_d_max_t_airs/1.json
  def destroy
